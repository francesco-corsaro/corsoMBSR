...
$pgwbi=array(
    ...
    array("3.	Nelle ultime 4 settimane, si è sentito depresso? Si, al punto di pensare di farla finita ",
...
for ($i = 0; $i < 22; $i++) {
    echo '<div class="col-12 tenda">
            <div class="roi">'.$pgwbi[$i][0].'</div>
            <div class="col-12">';
   /* echo $pgwbi[$i];*/
    $value=0;
    foreach ($pgwbi[$i] as $testo){
        ...
        if ($testo==$pgwbi[$i][0])  {
            ...
            echo '<div class="col-12">
                    <label class="contenitore" id="'.$i.$testo.'">
                        <div clas="joy">             
                        <input  name="pgwbi['.$i.']" type="radio" id="'.$i.$testo.'" value="'.$value.'"/>
                        <span class="buttondo" id="'.$i.$testo.'" ></span>
                        </div>
                       <div class="jay"><b><em>'.$testo.'</em></b></div>
 ...
 /*           
            <label class="contenitore" ><br>
                <b class="color">1</b> 
                <input  name="ffmq['.$i.']" type="radio" value="1"/>
                <span class="buttondo"></span>
            </label>
            <label class="contenitore" ><br>
                <b class="color">2</b> 
                <input checked="checked" name="ffmq['.$i.']" type="radio" value="2"/>
                <span class="buttondo"></span>
            </label>
            <label class="contenitore" ><br>
                <b class="color">3</b> 
                <input  name="ffmq['.$i.']" type="radio" value="3"/>
                <span class="buttondo"></span>
            </label>
            <label class="contenitore" ><br>
                <b class="color">4</b> 
                <input  name="ffmq['.$i.']" type="radio" value="4"/>
                <span class="buttondo"></span>
            </label>
            <label class="contenitore" ><br>
                <b class="color">5</b> 
                <input  name="ffmq['.$i.']" type="radio" value="5"/>
                <span class="buttondo"></span>
            </label>
          </div>';
}   
