...
$colonneSTAY1=array('Q4i1','Q4i2','Q4i3','Q4i4','Q4i5','Q4i6','Q4i7','Q4i8','Q4i9','Q4i10','Q4i11','Q4i12','Q4i13','Q4i14','Q4i15','Q4i16','Q4i17','Q4i18','Q4i19','Q4i20');
$colonneSTAY2=array('Q4i21','Q4i22','Q4i23','Q4i24','Q4i25','Q4i26','Q4i27','Q4i28','Q4i29','Q4i30','Q4i31','Q4i32','Q4i33','Q4i34','Q4i35','Q4i36','Q4i37','Q4i38','Q4i39','Q4i40');
$arrColonne=array($colonneFFMQ,$colonnePGWBI,$colonneMSP,$colonneSTAY1,$colonneSTAY2);
...
//            echo 'questo è l\'Id: '.$id.' id session'.$_SESSION['codice'].'Questo è il nome: '.$nome.'<br>';
        ...
        /* TEST FFMQ 
            ...
            Carica_testi($colonneFFMQ, $_SESSION['ffmq'][0], 'Ffmq', 'Id', $id);
            echo $stato1.'<br>'.$stato.'<br>';
        
        //test PGWBI
            Inserisci_id('Pgwbi',$id, $giorno);
            Carica_testi($colonnePGWBI, $_SESSION['pgwbi'][0], 'Pgwbi', 'Id', $id);
           echo $stato1.'<br>'.$stato.'<br>';
        
        // Test Msp   
            Inserisci_id('Msp', $id, $giorno);
            Carica_testi($colonneMSP,$_SESSION['msp'][0] , 'Msp', 'Id', $id);
//            echo $stato1.'<br>'.$stato.'<br>';
        //test Stay
            Inserisci_id('Stay', $id, $giorno);
            Carica_testi($colonneSTAY1, $_SESSION['stay1'][0], 'Stay', 'Id', $id);
            Carica_testi($colonneSTAY2, $_SESSION['stay2'][0], 'Stay', 'Id', $id);
//            echo $stato1.'<br>'.$stato.'<br>';
            
            echo'Grazie per aver partecipato<br>'; 
            $_SESSION['bypass']="1";
    ?>
