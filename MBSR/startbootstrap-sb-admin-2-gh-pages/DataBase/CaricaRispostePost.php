...
$giorno=date("Y-m-d");
        ...
        // inserisco Name
           ...
           //INSERISCE DATI NEL TEST FFMQ
            Inserisci_dato('PostFfmq', 'Name', $nome,'Id',$id,'Giorno',$giorno);
            //echo $stato.'<br>';
