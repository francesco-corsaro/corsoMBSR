...
<head>
  ...
  <title>Corso MBSR - Forgot Password</title>
  ...
  <style>
      .bgRegister {
            background-image: url("https://mindfulquestionnaire.altervista.org/MBSR/startbootstrap-sb-admin-2-gh-pages/img/amber-kipp-75715CVEJhI-unsplash3.jpg"); /* The image used */
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bgRegister"></div>
              <div class="col-lg-6">
                <div class="p-5">
